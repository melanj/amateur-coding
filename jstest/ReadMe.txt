================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : jstest Project Overview
===============================================================================

The application wizard has created this jstest application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your jstest application.
...
res\jstest.ico
    ...
    icon is included by the main resource file jstest.rc.
...
jstestDlg.h, jstestDlg.cpp - the dialog
    These files contain your CjstestDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in jstest.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CjstestDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named jstest.pch and a precompiled types file named StdAfx.obj.
